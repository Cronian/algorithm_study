...
## 알고리즘 스터디 
1. 모임시간 
 - 구글Meet  ( 주로 월요일 오후 9시 반 )
2. 스터디 내용
 - 매주 돌아가면서 한명씩 개발 자유주제에 대한 발표 진행 ( 약 10분 )
 - 매주 출제되는 필수문제 풀어오기
 - 풀어온 문제에 대해 간단한 리뷰 및 설명
...
2. 3번 문제 ( 도전문제 )
 - [[Hard] 1074. Number of Submatrices That Sum to Target](https://leetcode.com/problems/number-of-submatrices-that-sum-to-target/)

## Week 57 ( 미뤄짐 )
1. 1-2번 문제 ( 필수문제 )
 - [[Easy] 693. Binary Number with Alternating Bits](https://leetcode.com/problems/binary-number-with-alternating-bits/)
 - [[Medium] 838. Push Dominoes](https://leetcode.com/problems/push-dominoes/)
2. 3번 문제 ( 도전문제 )
...
1. 1-3번문제 ( 필수문제 )
 ...
 - [[Medium] 1054. Distant Barcodes](https://leetcode.com/problems/distant-barcodes/)
...
2. 숙제
 - [[Level1] [카카오 인턴] 키패드 누르기](https://programmers.co.kr/learn/courses/30/lessons/67256)
...
- [[Medium] 62. Unique Paths](https://leetcode.com/problems/unique-paths/)
- [[Medium] 1492. The kth Factor of n](https://leetcode.com/problems/the-kth-factor-of-n/)

## Week 18
- [[Easy] Xor Operation In An Array ](https://leetcode.com/problems/xor-operation-in-an-array/)
- [[Medium] Group The People Given The Group Size They Belong To](https://leetcode.com/problems/group-the-people-given-the-group-size-they-belong-to/)
...
## Week 9 & 10
- 이진 탐색 내용보기
- [[Easy] Search in a Binary Search Tree](https://leetcode.com/problems/search-in-a-binary-search-tree/)
